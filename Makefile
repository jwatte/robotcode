...
AVR_CFLAGS:=-Wall -Wno-switch -Os -mcall-prologues -mmcu=atmega328p -Iavr/libavr -std=gnu++0x -flto -ffunction-sections
AVR_LFLAGS:=-mmcu=atmega328p -Lbld/avrbin -lavr -lc -flto -Wl,-flto
