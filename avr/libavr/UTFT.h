...
template<> struct typemodes<HX8347A> {
  enum { xfer_mode = 16, serial_mode = 0, x_size = 239, y_size = 319 };
};
template<> struct typemodes<ILI9327> {
  enum { xfer_mode = 16, serial_mode = 0, x_size = 239, y_size = 399 };
};
/* ... todo: more */
template<> struct typemodes<HX8340B_8> {
  enum { xfer_mode = 8, serial_mode = 0, x_size = 175, y_size = 219 };
};
template<> struct typemodes<HX8340B_S> {
  enum { xfer_mode = 1, serial_mode = SERIAL_4PIN, x_size = 175, y_size = 219 };
};
/* ... todo: more */
...
class UTFT
{
    enum {
      display_model = model,
      disp_x_size = typemodes<model>::x_size,
      disp_y_size = typemodes<model>::y_size,
      display_transfer_mode = typemodes<model>::xfer_mode,
      display_serial_mode = typemodes<model>::serial_mode,
      force_long = 0xffffffffUL
    };
	public:
		UTFT();
		UTFT(int RS, int WR,int CS, int RST, int SER=0);
